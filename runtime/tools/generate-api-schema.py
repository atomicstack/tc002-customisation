...
EASING = enum_source('panel/transition.zig', 'Easing')
SAMPLES = array(integer(0, 255), maxItems=52)
HEX_SAMPLES = string(pattern='^(?:[0-9a-fA-F]{2}){0,52}$')
TRANSITION = dict(transition=EFFECT, direction=DIRECTION, transition_ms=integer(0, 5000), exit=EXIT, easing=EASING)
