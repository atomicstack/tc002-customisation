...
def request_schemas():
    ...
    update('CanvasBody', elements=array(ref('ElementBody'), maxItems=24))
...
def response_schemas(schemas):
    ...
    model('CanvasResponse', dict(revision=n, saved_revision=n, age_ms=n, elements=array(ref('ElementBody'), maxItems=24), limits=obj(dict(elements={'const': 24}, text_bytes={'const': 256}, data_bytes={'const': 1024}, samples={'const': 52}))))
