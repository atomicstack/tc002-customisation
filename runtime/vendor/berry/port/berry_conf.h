...
#define BE_EXPLICIT_MALLOC             tc002_berry_malloc
#define BE_EXPLICIT_FREE               tc002_berry_free
#define BE_EXPLICIT_REALLOC            tc002_berry_realloc
...
/* the tc002 seam: the host owns output and allocation. implemented in src/berry/vm.zig, so berryd
 * can send output to the log ring and allocate from a fixed arena without this vendored tree
